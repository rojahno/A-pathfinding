...
class Map_Obj():
    def __init__(self, task):
        self.start_pos, self.goal_pos, self.end_goal_pos, self.path_to_map = self.__fill_critical_positions(task)
    ...
    def __fill_critical_positions(self, task):
        """
    ...
    def __set_start_pos_str_marker(self, start_pos, map):
    ...
    def __set_goal_pos_str_marker(self, goal_pos, map):
    ...
    def show_map(self, map=None):
        ...
        if map is not None:
            self.__set_start_pos_str_marker(self.start_pos, map)
            self.__set_goal_pos_str_marker(self.goal_pos, map)
